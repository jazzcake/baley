...
var MutationPolicies = []MutationPolicy{
	...
	{Name: "record.register", Capability: "record:operate", EventType: "record.registered"}, {Name: "record.attach_commit", Capability: "record:operate", EventType: "record.commit_attached"}, {Name: "commit.attach", Capability: "record:operate", EventType: "commit.attached"}, {Name: "commit.verify_remote", Capability: "record:operate", EventType: "commit.remote_verified"}, {Name: "git.observe", Capability: "record:operate", EventType: "git.observed"},
}
