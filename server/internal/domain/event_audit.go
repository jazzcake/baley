...
func eventEntityPayloadKey(eventType string) string {
	keys := map[string]string{
		...
		"task.updated": "taskId", "task.moved": "taskId", "task.terminal_set": "taskId", "task.terminal_cleared": "taskId", "task.started": "taskId", "task.implemented_reported": "taskId", "task.confirmed": "taskId", "task.discarded": "taskId", "task.rework_started": "taskId", "task.blocked": "taskId", "task.unblocked": "taskId",
