...
type GraphDTO = {
  ...
  tasks: Array<{ id: string; publicId: number; laneId: string; phaseId: string; title: string; description: string; status: WorkspaceFixture["tasks"][number]["status"]; blockerReason?: string }>;
