...
| AE-AUTH-03 | `embedding-enablement` | `adoption` | 인증된 사람 승인 결속 및 Agent token | Workspace-scoped Agent token과 fresh preview에 결속된 인증된 일회용 사람 approval grant를 구현한다. | AE-01B | AE-03 | No |
